        ...
        <section id="projects" className="container py-12 md:py-24 bg-muted/50">
          ...
          <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
            ...
            <ProjectCard
              ...
              description="Technical and Assembly Team Member for the 2024 AIAA DBF competition. Assisted the hardware team in soldering electrical components and assembling the fuselage, wings and other components. Our team placed 20th out of 107 national and international teams."
            ...
            <ProjectGallery
              ...
              description="Used Structural Dynamics to analyze stress on a Rocket Body Engine under an 'earthquake' composed of harmonic loading in X, Y, and Z directions. Coded the solver in Python and ran it by accessing the Alabama Supercomputing Cluster."
            ...
            <ProjectGallery
              ...
              description="Used Patran/Nastran to analyze failure points for a self-developed pressure vessel. Developed and redeveloped designs to create a suitable pressure vessel, demonstrating project development skills in the face of failures."
